#include "isim/work/composite_adder_substractor_tb/testbench_arch.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        topvh = new Work_composite_adder_substractor_tb_testbench_arch("Composite_adder_substractor_tb");
